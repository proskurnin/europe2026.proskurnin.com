...
const days:Record<string,Stop[]>={
 ...
 '2026-09-19':[gap('stay','Апартаменты · сбор рюкзаков','yerevan','event-1'),p('vernissage','yerevan'),q('lunch','Tavern Yerevan','yerevan','Tavern Yerevan, 5 Amiryan Street, Yerevan','walk','event-3'),p('gum','yerevan'),p('english-park','yerevan'),gap('bags','Забрать рюкзаки · место хранения уточнить','yerevan'),{...p('evn','yerevan','taxi'),note:'Минивэн на пятерых, детское кресло; выезд с запасом на пробки.'}],
