...
export default function JourneyJournal({onVisit,execution}:{onVisit:(id:string)=>void;execution:any}){
 ...
 return <section className="journal-section">
  ...
  <p className="journal-source">Обновлено по документу {dateLabel(execution.updatedAt)} · Новые записи из Google Doc появляются после обновления сайта через Codex. Общие статусы изменяет владелец; личные заметки сохраняются на сервере в вашей учётной записи.</p>
